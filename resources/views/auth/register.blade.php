...
@section('content')
            ...
            <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data" id="register-form">
                ...
                <div class="flex md:flex-row flex-col justify-evenly px-6 py-4 items-center text-center">
                    <div class="grid grid-cols-3 ">
                        <div class="m-3">
                            <input type="radio" name="avatar_option" value="/images/avatars/avatar_1.jpg" id="avatar_1" class="hidden" required>
                    ...
                    <div>
                        <input
                            ...
                            id="file_input" type="file" name="avatar_choose" accept="image/*">
                    </div>
                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const avatarOption = document.querySelector('input[name="avatar_option"]:checked');
            const avatarChoose = document.getElementById('file_input');
            ...
            form.addEventListener('submit', function(e) {
                ...
                if (!avatarOption && !avatarChoose.files.length) {
                    e.preventDefault();
