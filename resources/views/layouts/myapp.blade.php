...
<body class="bg-sec-400">
        ...
        <header>
            <nav class="bg-sec-600 border-gray-200 px-4 lg:px-6 py-4 dark:bg-gray-800 ">
                <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl drop-shadow-2xl">
                    ...
                    <img src="{{ asset('images/logos/logo.png') }}" alt="B&P Car Rentals Logo" class="h-12 mr-10">
                    </a>
                        ...
                        <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                            ...
                            <li>
                                <a href="{{ route('client.services.index') }}">
                                     <div class="group text-center">
                                        <div class="group-hover:cursor-pointer">Services</div>
                                        <div
        ...
        <header>
            <nav class="bg-sec-600 border-gray-200 px-4 lg:px-6 py-4 dark:bg-gray-800">
                <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    {{-- LOGO --}}
                    <a href="{{ route('home') }}" class="flex items-center">
                    <img loading="lazy" src="/images/logos/logo.png" class="mr-3 h-30 w-40" alt="B&P Car Rentals" />
                    </a>
                    ...
                    @if (Auth::user()->role == 'admin')
                        ...
                        <div class="relative flex items-center">
                            <form id="logout-form" action="{{ route('logout') }}" method="POST">
                                @csrf
                                <button type="submit"
                                    class="text-white bg-black hover:bg-pr-600 font-medium rounded-lg text-sm px-3 py-2.5 text-center inline-flex items-center">
                ...
                <div class="md:flex md:justify-between">
                    <div class="mb-12 md:mb-0 flex justify-center ">
                        <a href="" class="flex items-center">
                            <img loading="lazy" src="/images/logos/logo.png" class="mr-3 h-24"
                                alt="Logo" />
                        </a>
                    </div>
    ...
    {{-- Flowbite JS - Place at the end of body --}}
    <script src="https://cdnjs.cloudflare.com/ajax/libs/flowbite/2.3.0/flowbite.min.js"></script>
    
    <script>
        // Custom admin dropdown toggle
