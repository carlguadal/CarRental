    ...
    <div class="flex md:flex-row flex-col justify-between max-w-screen-xl md:px-16 px-8 mx-auto gap-12 ">
                ...
                <div class="flex justify-between">
                    <div class="w-full mr-5">
                        ...
                        <input type="email" id="email"
                            ...
                            placeholder="Carl Patrick" required>
                    </div>
                    ...
                    <div class="w-full ">
                        ...
                        <input type="email" id="email"
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light"
                            placeholder="Montibocal" required>
                    </div>
                </div>
                <div class="flex justify-between">
                    <div class="w-full mr-5">
                        ...
                        <input type="email" id="email"
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light"
                            placeholder="brylleguadalquiver@gmail.com" required>
                    </div>
                    ...
                    <div class="w-full ">
                        ...
                        <input type="email" id="email"
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light"
                            placeholder="+63 9562997110" required>
                    </div>
                </div>
                <div>
                    <label for="subject"
        ...
        <div class="grid mx-auto text-center gap-4 ">
            <div>
                ...
                <p class="text-sm font-light text-gray-700 font-car">B&P Car Rentals Davao</p>
                <p class="text-sm font-light text-gray-700 font-car">Location: Davao City</p>
            </div>
            <div>
                <div class="w-20 p-6 mx-auto mb-3 bg-gray-200 rounded-md ">
                    <svg id="o" xmlns="http://www.w3.org/2000/svg" height="2em" viewBox="0 0 512 512">
                ...
                <p class="text-sm font-light text-gray-700 font-car">Emily Homes Catalunan Pequeno Street.10 B Side</p>
                <p class="text-sm font-light text-gray-700 font-car">Zip Code/Postal code:8000</p>
            </div>
            <div>
                <div class="w-20 p-6 mx-auto mb-3 bg-gray-200 rounded-md ">
                    <svg id="o" xmlns="http://www.w3.org/2000/svg" height="2em" viewBox="0 0 512 512">
                ...
                <p class="text-sm font-light text-gray-700 font-car">Call us to reserve a car or for any.
                    happy to help.
                </p>
                <p class="font-car text-pr-400 ">+63 9516549123</p>
            </div>
