...
class CarController extends Controller
{
    ...
    /**
     * Display a listing of archived cars.
     */
    ...
    {
        $car->restore();
        return redirect()->route('admin.archive')->with('success', 'Car restored successfully.');
    }

    public function forceDelete($car)
    {
        $car = \App\Models\Car::withTrashed()->findOrFail($car);
        $car->forceDelete();
        return redirect()->route('admin.archive')->with('success', 'Car permanently deleted.');
    }
}
